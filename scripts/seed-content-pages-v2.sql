...
-- Run with:
--   psql -U postgres -d content_insight -f scripts/seed-content-pages-v2.sql

-- Update overview text for each chapter.
UPDATE contents SET body = 'Algebra Basics introduces variables, expressions, and the structure of linear equations. Learn why solving for x is the foundation of algebraic reasoning.', order_index = 0 WHERE chapter_id = 1 AND title = 'Overview';
UPDATE contents SET body = 'Geometry covers shapes, angles, and theorems. Explore how triangles, circles, and polygons behave in space and how to calculate their properties.', order_index = 0 WHERE chapter_id = 2 AND title = 'Overview';
UPDATE contents SET body = 'Newton Laws shows how motion, inertia, and forces work together to govern everyday movement. Understand why objects accelerate the way they do.', order_index = 0 WHERE chapter_id = 3 AND title = 'Overview';
UPDATE contents SET body = 'Energy Concepts explores kinetic energy, potential energy, and the conservation of energy in physical systems.', order_index = 0 WHERE chapter_id = 4 AND title = 'Overview';
UPDATE contents SET body = 'Programming Basics introduces variables, control flow, and functions so you can write simple programs and understand code structure.', order_index = 0 WHERE chapter_id = 5 AND title = 'Overview';
UPDATE contents SET body = 'Data Structures explains arrays, stacks, and queues, and shows how these building blocks help organize data efficiently.', order_index = 0 WHERE chapter_id = 6 AND title = 'Overview';
